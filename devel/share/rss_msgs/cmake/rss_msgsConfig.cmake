...
if("TRUE" STREQUAL "TRUE")
  set(rss_msgs_SOURCE_PREFIX /home/rss-student/rss-2014-team-3/src/rss_msgs)
  set(rss_msgs_DEVEL_PREFIX /home/rss-student/rss-2014-team-3/devel)
  set(rss_msgs_INSTALL_PREFIX "")
  set(rss_msgs_PREFIX ${rss_msgs_DEVEL_PREFIX})
else()
  set(rss_msgs_SOURCE_PREFIX "")
  set(rss_msgs_DEVEL_PREFIX "")
  set(rss_msgs_INSTALL_PREFIX /home/rss-student/rss-2014-team-3/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rss_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'rss-team3 <rss-team3@lists.csail.mit.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rss_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rss-student/rss-2014-team-3/src/rss_msgs/${idir}'.  Ask the maintainer 'rss-team3 <rss-team3@lists.csail.mit.edu>' to fix it.")
    endif()
