...
(cl:defclass <GUIPointMsg> (roslisp-msg-protocol:ros-message)
  ((x
   ...
   (color
    :reader color
    :initarg :color
    :type gc_msgs-msg:ColorMsg
    :initform (cl:make-instance 'gc_msgs-msg:ColorMsg)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GUIPointMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GUIPointMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gc_msgs-msg:<GUIPointMsg> is deprecated: use gc_msgs-msg:GUIPointMsg instead.")))
...
(cl:defmethod shape-val ((m <GUIPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:shape-val is deprecated.  Use gc_msgs-msg:shape instead.")
  (shape m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <GUIPointMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:color-val is deprecated.  Use gc_msgs-msg:color instead.")
  (color m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GUIPointMsg>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%int64 shape~%ColorMsg color~%================================================================================~%MSG: gc_msgs/ColorMsg~%int64 r~%int64 g~%int64 b~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GUIPointMsg)))
  "Returns full string definition for message of type 'GUIPointMsg"
  (cl:format cl:nil "float64 x~%float64 y~%int64 shape~%ColorMsg color~%================================================================================~%MSG: gc_msgs/ColorMsg~%int64 r~%int64 g~%int64 b~%~%"))
