...
(cl:defmethod cl:initialize-instance :after ((m <GUIPolyMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GUIPolyMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gc_msgs-msg:<GUIPolyMsg> is deprecated: use gc_msgs-msg:GUIPolyMsg instead.")))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <GUIPolyMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:c-val is deprecated.  Use gc_msgs-msg:c instead.")
  (c m))

(cl:ensure-generic-function 'numVertices-val :lambda-list '(m))
(cl:defmethod numVertices-val ((m <GUIPolyMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:numVertices-val is deprecated.  Use gc_msgs-msg:numVertices instead.")
  (numVertices m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <GUIPolyMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:x-val is deprecated.  Use gc_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <GUIPolyMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:y-val is deprecated.  Use gc_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'closed-val :lambda-list '(m))
(cl:defmethod closed-val ((m <GUIPolyMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:closed-val is deprecated.  Use gc_msgs-msg:closed instead.")
  (closed m))

(cl:ensure-generic-function 'filled-val :lambda-list '(m))
(cl:defmethod filled-val ((m <GUIPolyMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:filled-val is deprecated.  Use gc_msgs-msg:filled instead.")
  (filled m))
