...
(cl:defmethod cl:initialize-instance :after ((m <MotionMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotionMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gc_msgs-msg:<MotionMsg> is deprecated: use gc_msgs-msg:MotionMsg instead.")))

(cl:ensure-generic-function 'translationalVelocity-val :lambda-list '(m))
(cl:defmethod translationalVelocity-val ((m <MotionMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:translationalVelocity-val is deprecated.  Use gc_msgs-msg:translationalVelocity instead.")
...
(cl:defmethod rotationalVelocity-val ((m <MotionMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gc_msgs-msg:rotationalVelocity-val is deprecated.  Use gc_msgs-msg:rotationalVelocity instead.")
