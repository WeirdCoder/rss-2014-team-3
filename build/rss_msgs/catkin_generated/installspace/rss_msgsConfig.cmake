...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rss_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rss-student/rss-2014-team-3/install/${idir}'.  Ask the maintainer 'rss-team3 <rss-team3@lists.csail.mit.edu>' to fix it.")
    endif()
