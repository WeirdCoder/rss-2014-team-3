...
cd "/home/rss-student/rss-2014-team-3/src/robotbrain"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/rss-student/rss-2014-team-3/src/robotbrain/setup.py" \
    build --build-base "/home/rss-student/rss-2014-team-3/build/robotbrain" \
    install \
    $DESTDIR_ARG \
