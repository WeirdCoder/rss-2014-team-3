...
cd "/home/rss-student/rss-2014-team-3/src/odometry"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/rss-student/rss-2014-team-3/src/odometry/setup.py" \
    build --build-base "/home/rss-student/rss-2014-team-3/build/odometry" \
    install \
    $DESTDIR_ARG \
