...
public abstract class WheelVelocityController extends VelocityController {
   ...
   **/
  protected static final double MAX_ANGULAR_VELOCITY = 9.95;
   ...
   **/
  //TODO: do this the right way when I give more shits
   ...
   **/
  public static final double TICKS_PER_REVOLUTION = ENCODER_RESOLUTION * GEAR_RATIO;
