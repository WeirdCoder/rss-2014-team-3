...
public class SonarGUI extends VisionGUI {
	 ...
	 **/
	public static final double POINT_RADIUS = 1;
	...
	protected class GUIPoint extends Glyph {
		...
		public boolean equals(Object other) {
			if (!(other instanceof GUIPoint)) return false;
			...
			switch (shapeType) {
				case X_POINT:
					...
					if ( a0.getX1() != b0.getX1() ||
							a0.getX2() != b0.getX2() ||
							a1.getX1() != a1.getX1() ||
							a1.getX2() != b1.getX2() ) return false;
					break;
				case O_POINT:
	 ...
	 **/
	@Override protected void paintInWorldOverPosesHook(Graphics2D g2d) {
	...
	protected void paintPoints(Graphics2D g2d) {
		...
		setLineWidth(g2d, 100.0f);

		synchronized (points) {
			for (Iterator<GUIPoint> it = points.iterator(); it.hasNext(); )
				it.next().paint(g2d);
		}
	}
	...
	public Subscriber<lab5_msgs.GUILineMsg> guiLineSub;
	public Subscriber<lab5_msgs.GUISegmentMsg> guiSegmentSub;
	public Subscriber<lab5_msgs.GUIPointMsg> guiPointSub;
	public Subscriber<lab5_msgs.GUIEraseMsg> guiEraseSub;
