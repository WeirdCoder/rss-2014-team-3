...
public class MapGUI extends SonarGUI implements NodeMain{
	...
	private Subscriber<lab6_msgs.GUIRectMsg> guiRectSub;
	private Subscriber<lab6_msgs.GUIPolyMsg> guiPolySub;
	private Subscriber<lab5_msgs.GUIEraseMsg> guiEraseSub;
